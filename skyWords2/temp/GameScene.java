...
public class GameScene extends BaseScene{
	...
	//Entity for letters
	//private static final Object TAG_ENTITY_ATTRIBUTE_TYPE_VALUE_letter = "letter";
	...
	private void createHUD()
	{
		...
		scoreText = new Text(400, 0, resourcesManager.font, "Score: 0123456789", new TextOptions(HorizontalAlign.LEFT), vbom);
	...
	private void loadLevel(int levelID){
		...
		final FixtureDef FIXTURE_DEF = PhysicsFactory.createFixtureDef(0,0.1f, 0.5f);
